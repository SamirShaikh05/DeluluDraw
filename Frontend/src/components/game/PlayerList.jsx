...
export const PlayerList = memo(function PlayerList({ drawerId, hostId, kickVotes = {}, myId, onKickVote, players, spectators = [], showKickVotes = false }) {
  ...
  return (
    <aside className="player-list h-full min-h-0 overflow-y-auto overscroll-contain border-[3px] border-[#0c3579] bg-white md:border-t-0 max-md:grid max-md:grid-cols-[repeat(auto-fit,minmax(200px,1fr))]">
