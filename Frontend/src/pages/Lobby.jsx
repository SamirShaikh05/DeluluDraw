...
export function Lobby({ goHome, isHost, notice, players, room, startGame }) {
  return (
    <section className="relative z-10 mx-auto my-[58px] grid w-[min(100%-20px,620px)] grid-cols-1 gap-[18px] md:w-[min(100%-28px,920px)] md:grid-cols-[minmax(0,1fr)_290px]">
      <div className="rounded-lg border-4 border-[rgba(255,255,255,0.16)] bg-[rgba(9,50,122,0.58)] p-7 text-white md:p-[42px]">
        <p className="m-0 font-black uppercase text-[#f2e84b]">Private room</p>
        <h1 className="my-2.5 text-[58px] leading-none font-black md:text-[84px]">{room.roomId}</h1>
        <p className="max-w-[560px] text-lg font-bold leading-[1.5]">Share this code with friends. The host starts the game when the room feels loud enough.</p>
